...
export function BudgetTemplate3({ header, client, items, desconto, logo, finalizedDate, serialNumber }: BudgetTemplateProps) {
  return (
    <div className="budget-document bg-slate-50 dark:bg-slate-900 p-4 font-sans">
      <div className="max-w-4xl mx-auto space-y-3">
        <div className="bg-slate-900 dark:bg-slate-800 text-white px-4 py-2.5 rounded-lg">
          <BudgetTitleTech finalizedDate={finalizedDate} serialNumber={serialNumber} />
        </div>
