...
export function BudgetTemplate1({ header, client, items, desconto, logo, finalizedDate, serialNumber }: BudgetTemplateProps) {
  return (
    <div className="budget-document bg-white dark:bg-slate-900 p-4 font-sans">
      <div className="max-w-4xl mx-auto space-y-3">
        <BudgetTitleModern finalizedDate={finalizedDate} serialNumber={serialNumber} />
